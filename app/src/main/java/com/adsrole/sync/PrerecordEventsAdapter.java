...
public class PrerecordEventsAdapter extends RecyclerView.Adapter<PrerecordEventsAdapter.CategoryHolder> {

    List<Category> catlist;
    Context context;
    public PrerecordEventsAdapter(Context context, List<Category> catlist) {
    ...
    public CategoryHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.prerecordevents_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull CategoryHolder holder, int position) {
        ...
        holder.category_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent category = new Intent(context, PrerecordEventsActivity.class);
